...
if [ -x "./cardano-cli" ]; then
    ...
    wget -P . https://github.com/IntersectMBO/cardano-cli/releases/download/cardano-cli-10.1.1.0/cardano-cli-10.1.1.0-x86_64-linux.tar.gz
    tar -xzf ./cardano-cli-10.1.1.0-x86_64-linux.tar.gz -C .
    chmod +x ./cardano-cli-x86_64-linux
    mv ./cardano-cli-x86_64-linux ./cardano-cli
    rm ./cardano-cli-10.1.1.0-x86_64-linux.tar.gz
