...
cardano-cli query utxo --socket-path ${socket_path} --address ${batcher_address} ${network}

echo -e "\n \033[1;35mCollateral: ${collat_address} \033[0m \n";
cardano-cli query utxo --socket-path ${socket_path} --address ${collat_address} ${network}